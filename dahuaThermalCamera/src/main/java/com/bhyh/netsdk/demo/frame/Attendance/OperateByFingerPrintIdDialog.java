package com.bhyh.netsdk.demo.frame.Attendance;
...
import com.bhyh.netsdk.common.BorderEx;
import com.bhyh.netsdk.common.Res;
import com.bhyh.netsdk.demo.module.AttendanceModule;
import com.bhyh.netsdk.demo.module.AttendanceModule.OPERATE_TYPE;
import com.bhyh.netsdk.demo.module.AttendanceModule.UserData;
...
public class OperateByFingerPrintIdDialog extends JDialog{
	...
	private String formatFingerPrintData(byte[] fingerPrintData) {
		String formatData = com.bhyh.netsdk.common.Base64.getEncoder().encodeToString(fingerPrintData);
		return formatData;
	}
